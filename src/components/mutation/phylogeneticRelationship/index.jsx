...
export default function PhylogeneticRelationship() {
    ...
    return (
        <Row style={{ height: "100%" }}>
            ...
            patientList.map((item) => {
                return <Col xs={24} sm={24} md={24} lg={24} key={item.id} style={{border: "1px solid #f0f0f0", borderRadius: "12px"}}>
                    <iframe
                        src={`/html/tree.html?newick=${item.newick}`}
                        width="100%"
                        height="520px"
                        frameBorder="0"
                    /></Col>
            ...
            <iframe
                id='myIframe'
                src={`http://localhost:4000/flu/avian/h7n9/ha?c=num_date&d=tree,map&p=grid&transmissions=hide`}
                width="100%"
                height="1500px"
                frameBorder="0"
            />
